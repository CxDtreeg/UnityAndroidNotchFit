...
import com.youle.unityproject.config.NotchConfig;
...
public abstract class AbstractNotch implements INotch{
    ...
    public int[] getNotchSize(){
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.P) return getNotchSize_O(UnityPlayer.currentActivity);
        return getNotchSize_P(UnityPlayer.currentActivity);
    }
