package com.youle.unityproject;
...
import com.youle.unityproject.args.NotchProperty;
import com.youle.unityproject.args.NotchScreenType;
import com.youle.unityproject.core.NotchFactory;
import com.youle.unityproject.core.OnNotchCallBack;
import com.youle.unityproject.utils.ActivityUtils;
...
public class NotchFit {
    ...
    public static int[] getNotchSize() {
        return NotchFactory.getInstance().getNotch().getNotchSize();
    }
